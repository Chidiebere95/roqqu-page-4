...
const Home = ({ title }) => {
  ...
  ws.onmessage=(event)=>{
    ...
    const obj={
      ...
      y:[(parseFloat(stockObj.k.o)),(parseFloat(stockObj.k.c)),(parseFloat(stockObj.k.h)),(parseFloat(stockObj.k.l))]
    }
    console.log(obj);
    // const  series= [{
    //   data: [{
          ...
          <div className="flex charts-book">
            <div className="charts">
              ...
              <div className="charts-container">
                ...
                <ApexChart options={options} series={series} type="candlestick" height={370} />
